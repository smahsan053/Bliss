  ...
  return (
    <div>
      <Container className="flex flex-col md:flex-row gap-10 py-10 ">
        {product?.image && (
          <div className="w-full md:w-1/2 h-auto border border-lightPurple/20 shadow-md rounded-md group overflow-hidden">
            <Image
        ...
        <div className="w-full md:w-1/2 flex flex-col gap-5">
          ...
          <div className="flex flex-wrap items-center gap-5">
            <div className="border border-lightPurple/20 text-center p-3 hover:border-lightPurple hoverEffect rounded-md">
